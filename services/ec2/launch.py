...
keypair_input = raw_input("Do you want to create a new key pair for this instance? [y/n]\n")
if keypair_input is 'y' or 'Y':
    keypair_name=str(raw_input("Type name of the key pair\n"))
    vpc_region.create_key_pair(keypair_name)
elif keypair_input is 'n' or 'N':
